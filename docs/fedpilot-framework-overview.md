...
Repository: [github.com/fedpilot](https://github.com/fedpilot)
...
3. Check [Examples]({{ site.baseurl }}/examples/basic-training) for practical implementations
4. Visit [GitHub Repository](https://github.com/fedpilot/core) for source code
